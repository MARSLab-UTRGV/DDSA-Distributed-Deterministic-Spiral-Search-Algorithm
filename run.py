...
def Experiment1(rc):
    ...
    for j in range(run_count):
        time.sleep(0.05)
        print(f'DDSA-Cenralized Experiment 1: 4 regions,  Iteration: {j+1}/{run_count}\n')
        os.system(f'argos3 -c {xml_rg4}')
    
    #for j in range(run_count):
    #    time.sleep(0.05)
    #    print(f'DDSA-Cenralized Experiment 1: 16 regions,  Iteration: {j+1}/{run_count}\n')
    #    os.system(f'argos3 -c {xml_rg16}')
    
    #for j in range(run_count):
    #    time.sleep(0.05)
    #    print(f'DDSA-Cenralized Experiment 1: 64 regions,  Iteration: {j+1}/{run_count}\n')
...
def Experiment2(rc):
    ...
    for j in range(run_count):
        time.sleep(0.05)
        print(f'DDSA-Cenralized Experiment 2: 8 robots,  Iteration: {j+1}/{run_count}\n')
        os.system(f'argos3 -c {xml_r8}')
    
    for j in range(run_count):
        time.sleep(0.05)
        print(f'DDSA-Cenralized Experiment 2: 14 robots,  Iteration: {j+1}/{run_count}\n')
        os.system(f'argos3 -c {xml_r14}')

    for j in range(run_count):
        time.sleep(0.05)
        print(f'DDSA-Cenralized Experiment 2: 20 robots,  Iteration: {j+1}/{run_count}\n')
        os.system(f'argos3 -c {xml_20}')
    
    for j in range(run_count):
        time.sleep(0.05)
        print(f'DDSA-Cenralized Experiment 2: 26 robots,  Iteration: {j+1}/{run_count}\n')
        os.system(f'argos3 -c {xml_r26}')

    for j in range(run_count):
        time.sleep(0.05)
        print(f'DDSA-Cenralized Experiment 2: 32 robots,  Iteration: {j+1}/{run_count}\n')
